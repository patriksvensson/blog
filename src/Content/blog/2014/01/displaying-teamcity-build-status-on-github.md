...
description: Have you ever wanted to display the current CI build status for a TeamCity project in your GitHub README? I did but couldn't find any good, straight forward information about how to do it. Turns out it's quite simple.
...
The markdown example below shows the build status icon with a link to the TeamCity build status page.
